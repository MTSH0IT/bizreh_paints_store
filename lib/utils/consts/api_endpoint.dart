class ApiEndpoint {
  ...
  //offers cart
  static const String getOffersCartAvailable = "/user/offers-cart/available";
  static String purchaseOffersCart(int id) => "/user/offers-cart/$id/purchase";
  ...
  //version
  static const String getVersion = "/user/version";
}
