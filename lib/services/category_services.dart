...
class CategoryServices {
  ...
  Future<List<SuperCategoreyModel>> getSuperCategories() async {
    try {
      final response = await _dioClient.get(ApiEndpoint.superCategories);
      ...
      if (err is AppException) {
        log(
          "category service AppException get super category : ${err.message}${err.statusCode}",
        );
        throw err;
      }
      log("category service DioException get super category : ${e.message}");
  ...
  Future<List<CategoryModel>> getCategories({String? title}) async {
    try {
      ...
      if (err is AppException) {
        log(
          "category service AppException get categories : ${err.message}${err.statusCode}",
        );
        throw err;
      }
      log("category service DioException get categories : ${e.message}");
      throw Exception(e.message);
    } catch (e) {
  ...
  Future<List<SubCategoreyModel>> getSubCategories() async {
    try {
      final response = await _dioClient.get(ApiEndpoint.subCategories);
      ...
      if (err is AppException) {
        log(
          "category service AppException get sub categories : ${err.message}${err.statusCode}",
        );
        throw err;
      }
      log("category service DioException get sub categories : ${e.message}");
      throw Exception(e.message);
    } catch (e) {
  ...
  Future<List<CategoryTreeModle>> getCategoryTree() async {
    try {
      final response = await _dioClient.get(ApiEndpoint.categoryTree);
      ...
      if (err is AppException) {
        log(
          "category service AppException get category tree : ${err.message}${err.statusCode}",
        );
        throw err;
      }
      log("category service DioException get category tree : ${e.message}");
      throw Exception(e.message);
    } catch (e) {
  ...
  Future<SubCategoreyModel> getSuperCategory({required int id}) async {
    try {
      final response = await _dioClient.get(ApiEndpoint.superCategoryById(id));
  ...
  Future<CategoryModel> getCategory({required int id}) async {
    try {
      final response = await _dioClient.get(ApiEndpoint.categoryById(id));
      ...
      if (err is AppException) {
        log(
          "category service AppException get category : ${err.message}${err.statusCode}",
        );
        throw err;
      }
      log("category service DioException get category : ${e.message}");
      throw Exception(e.message);
    } catch (e) {
  ...
  Future<SubCategoreyModel> getSubCategory({required int id}) async {
    try {
      final response = await _dioClient.get(ApiEndpoint.subCategoryById(id));
      ...
      if (err is AppException) {
        log(
          "category service AppException get sub category : ${err.message}${err.statusCode}",
        );
        throw err;
      }
      log("category service DioException get sub category : ${e.message}");
      throw Exception(e.message);
    } catch (e) {
